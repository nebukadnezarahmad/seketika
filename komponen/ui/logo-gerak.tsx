/** Lambang SEKETIKA sebagai SVG sebaris, supaya bagian-bagiannya bisa digerakkan sendiri-sendiri. */
export function LogoGerak({
  ...
  return (
    ...
    >
      ...
      {/* Gerobak: batang, dua roda, dan gandarnya. */}
      <g className={g("lg-gerobak")}>
        ...
        <g
          className={g("lg-roda")}
          style={{ transformOrigin: "40.34px 127px" }}
        >
        ...
        <g
          className={g("lg-roda")}
          style={{ transformOrigin: "88.16px 127px" }}
        >
      ...
      <g
        className={g("lg-sinar lg-sinar-1")}
        style={{ transformOrigin: "63.75px 45px" }}
      >
        <rect
          width="21.7661"
      ...
      <g
        className={g("lg-sinar lg-sinar-2")}
        style={{ transformOrigin: "63.75px 45px" }}
      >
        <rect
          width="21.7139"
      ...
      <g
        className={g("lg-sinar lg-sinar-3")}
        style={{ transformOrigin: "63.75px 45px" }}
      >
        <rect
          width="21.6979"
