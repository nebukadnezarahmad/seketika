...
/** Satu baris dalam daftar pengaturan: kotak ikon berwarna, judul, keterangan, lalu tanda panah. */
export function BarisMenu({
  ...
  const dalam = (
    <>
      <span
        className={`grid size-10 shrink-0 place-items-center rounded-[12px] ${warna[nada]}`}
      >
