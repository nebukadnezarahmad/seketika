...
export const pesananAwal: Pesanan[] = [
  ...
  },
  {
    ...
    baris: [
      { menuId: "m-06", nama: "Nasi Goreng Spesial", harga: 17000, jumlah: 1 },
    ],
    status: "selesai",
  ...
  },
  {
    ...
    baris: [
      { menuId: "m-10", nama: "Mie Ayam Bakso", harga: 12000, jumlah: 2 },
    ],
    status: "selesai",
...
export const titikKumpulAwal: TitikKumpul[] = [
  ...
  /* Permintaan kedua untuk gerobak sendiri. */
  {
    id: "tk-05",
    ...
    pesan: [
      {
        id: "p1",
        saya: true,
        isi: "Kak, saya pesan 2 bakso urat sama 1 es teh ya",
        waktu: "09:38",
      },
      {
        id: "p2",
        saya: false,
        isi: "Siap kak! Ditunggu ya, kurang lebih 10 menit.",
        waktu: "09:39",
      },
      {
        id: "p3",
        saya: true,
        isi: "Oke, saya tunggu di depan gerbang",
        waktu: "09:41",
      },
      {
        id: "p4",
        saya: false,
        isi: "Pesanan Anda sedang kami siapkan ya!",
        waktu: "09:43",
      },
    ],
  },
    ...
    pesan: [
      {
        id: "p1",
        saya: true,
        isi: "Kang, bayam sama kangkungnya ada ga?",
        waktu: "16:10",
      },
      {
        id: "p2",
        saya: false,
        isi: "Ada kak, bayam 1 ikat 3000, kangkung 2500 per ikat.",
        waktu: "16:12",
      },
      {
        id: "p3",
        saya: true,
        isi: "Ambil 2 bayam sama 2 kangkung ya kang",
        waktu: "16:13",
      },
      ...
      { id: "p5", saya: true, isi: "Oke dibayar cash ya kang", waktu: "16:16" },
      {
        id: "p6",
        saya: false,
        isi: "Makasih banyak kak! \u{1F64F}",
        waktu: "16:20",
      },
    ],
  },
    ...
    pesan: [
      {
        id: "p1",
        saya: true,
        isi: "Bu, donatnya masih ada ga?",
        waktu: "10:00",
      },
      {
        id: "p2",
        saya: false,
        isi: "Masih kak! Mau berapa? Ada coklat, gula, sama keju.",
        waktu: "10:02",
      },
      { id: "p3", saya: true, isi: "3 coklat, 2 keju ya bu", waktu: "10:03" },
      {
        id: "p4",
        saya: false,
        isi: "Oke kak, total 12.500 ya.",
        waktu: "10:05",
      },
      {
        id: "p5",
        saya: true,
        isi: "Donat cokelatnya enak banget bu!",
        waktu: "10:40",
      },
    ],
  },
    ...
    pesan: [
      {
        id: "p1",
        saya: true,
        isi: "Bu Siti, pesan nasi goreng spesial 1 porsi",
        waktu: "18:20",
      },
      { id: "p2", saya: false, isi: "Siap kak! 15 menit ya.", waktu: "18:21" },
      {
        id: "p3",
        saya: false,
        isi: "Nasi goreng spesialnya sudah siap kak",
        waktu: "18:36",
      },
    ],
  },
...
export const rupaPercakapan: Record<
  string,
  { foto: string; daring: boolean; kapan: string }
> = {
...
/** Pesanan yang masuk ke gerobak, isinya mengikuti layar pedagang di berkas desain: Bu Rahma dan Pak Dedi masih baru, Kak Budi sedang diproses, sisanya sudah selesai hari ini. */
export const pesananMasukAwal: PesananMasuk[] = [
  ...
  },
  {
    ...
    baris: [{ menuId: "m-04", nama: "Bakso Telur", harga: 15000, jumlah: 4 }],
    status: "diproses",
    menitLalu: 20,
  },
  {
...
/** Percakapan dari sisi pedagang: lawan bicaranya warga, bukan sesama pedagang. */
    ...
    pesan: [
      {
        id: "p1",
        saya: false,
        isi: "Pak, baksonya masih ada ga? Mau pesan 3 porsi nih",
        waktu: "09:35",
      },
      {
        id: "p2",
        saya: true,
        isi: "Masih ada Mas! Lagi di sekitar Jl. Melati. 10 menit lagi sampai ya",
        waktu: "09:37",
      },
      {
        id: "p3",
        saya: false,
        isi: "Siap pak, saya tunggu di depan pos satpam",
        waktu: "09:40",
      },
      {
        id: "p4",
        saya: true,
        isi: "Oke, saya menuju ke sana sekarang!",
        waktu: "09:41",
      },
      {
        id: "p5",
        saya: false,
        isi: "Oke, saya tunggu di depan gerbang ya pak",
        waktu: "09:43",
      },
    ],
  },
    ...
    pesan: [
      {
        id: "p1",
        saya: false,
        isi: "Pak, minta tolong berhenti sebentar di gang Mangga ya",
        waktu: "14:05",
      },
      {
        id: "p2",
        saya: true,
        isi: "Bisa bu, sekitar 5 menit lagi sampai",
        waktu: "14:06",
      },
      {
        id: "p3",
        saya: false,
        isi: "Mau beli 2 bakso urat sama 2 bakso tahu",
        waktu: "14:08",
      },
      {
        id: "p4",
        saya: true,
        isi: "Siap bu! Sudah sampai di gang Mangga",
        waktu: "14:11",
      },
      {
        id: "p5",
        saya: false,
        isi: "Makasih banyak pak, bungkusannya rapi!",
        waktu: "14:20",
      },
    ],
  },
    ...
    pesan: [
      {
        id: "p1",
        saya: false,
        isi: "Pak, hari ini lewat kompleks Permai ga?",
        waktu: "11:00",
      },
      {
        id: "p2",
        saya: true,
        isi: "Iya mas, biasanya jam 11 saya lewat sana",
        waktu: "11:01",
      },
      {
        id: "p3",
        saya: false,
        isi: "Wah sudah lewat belum? Saya mau beli nih",
        waktu: "11:30",
      },
      {
        id: "p4",
        saya: true,
        isi: "Aduh, tadi sudah lewat mas. Besok saya lewat lagi",
        waktu: "11:32",
      },
      {
        id: "p5",
        saya: false,
        isi: "Besok jualan lagi jam berapa pak?",
        waktu: "11:33",
      },
    ],
  },
    ...
    pesan: [
      {
        id: "p1",
        saya: false,
        isi: "Pak, mau tanya, bakso isi ayam ada ga?",
        waktu: "10:10",
      },
      {
        id: "p2",
        saya: true,
        isi: "Ada mbak! Bakso ayam, sapi, dan campuran. Mau yang mana?",
        waktu: "10:12",
      },
      {
        id: "p3",
        saya: false,
        isi: "Campur aja pak, 2 porsi. Saya di blok B12",
        waktu: "10:14",
      },
      {
        id: "p4",
        saya: true,
        isi: "Siap, hari ini sudah habis mbak. Besok ya saya lewat blok B",
        waktu: "10:20",
      },
      {
        id: "p5",
        saya: false,
        isi: "Oke pak, ditunggu besok ya!",
        waktu: "10:21",
      },
    ],
  },
...
/** Rupa lawan bicara di sisi pedagang. */
...
function riwayatLama(): PesananMasuk[] {
  ...
  /* Jamnya tetap berkelompok pagi, siang, dan sore dengan sore paling padat, sama seperti minggu terakhir yang ditulis tangan. */
...
export const riwayatPedagangAwal: PesananMasuk[] = [
  ...
  },
  {
    ...
    status: "selesai",
    menitLalu: 0,
    selesaiPada: hariLalu(1, 17, 20),
  },
  {
    id: "rw-05",
    warga: "Bu Lina",
    inisial: "L",
    titik: "RT 02 Taman Bermain",
    baris: [{ menuId: "m-03", nama: "Bakso Polos", harga: 13000, jumlah: 3 }],
    status: "selesai",
    menitLalu: 0,
    selesaiPada: hariLalu(1, 18, 10),
  },
